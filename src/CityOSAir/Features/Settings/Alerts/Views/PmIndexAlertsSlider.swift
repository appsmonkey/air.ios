...
protocol PmIndexAlertsSliderDelegate {
...
class StyleKit: NSObject {
  ...
  //// Drawing Methods
  static func drawSlider(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 156, height: 400),
                         resizing: ResizingBehavior = .aspectFit, factor: CGFloat = 0.0, sections: CGFloat = 10,
...
class PmIndexAlertsSliderLayer: CALayer {
  ...
  override init(layer: Any) {
    ...
    if let layer = layer as? PmIndexAlertsSliderLayer {
      factor = layer.factor
    }
  }
...
class Palette {
  ...
  init(viewBackgroundColor: UIColor? = nil, sliderBackgroundColor: UIColor? = nil, sliderColor: UIColor? = nil) {
...
class PmIndexAlertsSlider: UIView {
  ...
  private var factor: CGFloat = 0.0 {
    willSet {
      (layer as? PmIndexAlertsSliderLayer)?.factor = newValue
  ...
  var delegate: PmIndexAlertsSliderDelegate? {
    didSet {
  ...
  override class var layerClass: AnyClass {
    return PmIndexAlertsSliderLayer.self
  }
  ...
  init(frame: CGRect, selectedSection: Int, sections: Int, palette: Palette = Palette()) {
    super.init(frame: frame)
  ...
  override func draw(_ layer: CALayer, in ctx: CGContext) {
    guard let layer: PmIndexAlertsSliderLayer = layer as? PmIndexAlertsSliderLayer else { return }
  ...
  private func addPanGesture() {
    let gesture = UIPanGestureRecognizer(target: self, action: #selector(PmIndexAlertsSlider.dragged(gesture:)))
  ...
  @objc
  private func dragged(gesture: UIPanGestureRecognizer) {
